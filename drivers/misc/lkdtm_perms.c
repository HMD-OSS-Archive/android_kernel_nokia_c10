 ...
 */
/*[test56955][MNT-297] odm add for android kernel hardening begin QJK*/
static noinline void do_nothing(void)
/*[test56955][MNT-297] odm add for android kernel hardening end QJK*/
{
	return;
}
...
void lkdtm_EXEC_RODATA(void)
{
	...
	execute_location((void *)rodata, CODE_AS_IS);
}
