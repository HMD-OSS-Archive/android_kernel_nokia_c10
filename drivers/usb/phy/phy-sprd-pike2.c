...
/*jinke add for usb eye-pattern modify 2020-11-26 begin*/
#define OTG_CTRL0_USB20_SET1(x) (((x) & 0x3) << 30)
/*jinke add for usb eye-pattern modify 2020-11-26 end*/
...
{
    void __iomem *reg_base = ioremap_nocache(0x20E0302C,4);
    uint32_t value;
    value = readl_relaxed(reg_base);
    value |= OTG_CTRL0_USB20_SET1(2);
