				...
				unsigned int flags)
{
	...
	//redmine 67303 fixed screen appears, and the phone restarts unsuccessfully wqy 20210312 begin
	if (!sg_policy->policy->freq_table)
		return;
	//redmine 67303 fixed screen appears, and the phone restarts unsuccessfully wqy 20210312 end	
	util = sugov_get_util(&max, sg_cpu->cpu);
